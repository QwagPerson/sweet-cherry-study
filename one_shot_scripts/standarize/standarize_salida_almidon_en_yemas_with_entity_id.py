...
# maestro IDs. Generates "entrada_almidon_en_yemas.csv" that contains the original data but with an
...
input_file_path  = data_path / "raw" / "FIA Salida 2024- Almidón en yemas.xlsx"
output_file_path = "salida_almidon_en_yemas_with_entity_id.csv"
...
df = df[['entidad_id', 'fecha muestreo', 'peso y. reprod (mg)', 'absorbancia', 'concentración %']]

# Rename columns to more descriptive names
df.rename(
    columns={
        'fecha muestreo'       : 'fecha',
        'peso y. reprod (mg)'  : 'peso_yema_mg',
        'absorbancia'          : 'absorbancia',
        'concentración %'      : 'concentracion_almidon_mg_por_g'
    },
    inplace=True
)
