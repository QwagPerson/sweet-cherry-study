#############################################################################################################
# Simple script used to standarize "entrada_materia_seca.csv" by mapping text columns to their respective
# maestro IDs. Generates "entrada_materia_seca_with_entity_id.csv" that contains the original data but with an
...
input_file_path  = data_path / "clean" / "entrada_materia_seca.csv"
output_file_path = "entrada_materia_seca_with_entity_id.csv"
