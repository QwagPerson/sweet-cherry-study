#############################################################################################################
# Simple script used to standarize "FIA Entrada 2024 - Caída de hojas.xlsx" by mapping text columns to their respective
# maestro IDs. Generates "entrada_caida_hojas_with_entity_id.csv" that contains the original data but with an
...
input_file_path  = data_path / "clean" / "entrada_caida_de_hojas.csv"
output_file_path = "entrada_caida_hojas_with_entity_id.csv"
...
df = df.rename(columns={
    'a %': 'porcentaje_amarilla',
    'va %': 'porcentaje_verde_amarilla',
    'v%': 'porcentaje_verde',
